...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetCompatibleAudioEncoderConfigurations'.
        /// </summary>
        public class GetCompatibleAudioEncoderConfigurationsCommandInvoker : CommandInvoker<GetCompatibleAudioEncoderConfigurationsRequestPayload, GetCompatibleAudioEncoderConfigurationsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetCompatibleAudioEncoderConfigurationsCommandInvoker"/> class.
            /// </summary>
            public GetCompatibleAudioEncoderConfigurationsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetCompatibleAudioEncoderConfigurations", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetCompatibleAudioEncoderConfigurations";
            }
        }
    }
}
