...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetMetadataConfiguration'.
        /// </summary>
        public class GetMetadataConfigurationCommandInvoker : CommandInvoker<GetMetadataConfigurationRequestPayload, GetMetadataConfigurationResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetMetadataConfigurationCommandInvoker"/> class.
            /// </summary>
            public GetMetadataConfigurationCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetMetadataConfiguration", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetMetadataConfiguration";
            }
        }
    }
}
