...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetCompatibleAudioSourceConfigurations'.
        /// </summary>
        public class GetCompatibleAudioSourceConfigurationsCommandInvoker : CommandInvoker<GetCompatibleAudioSourceConfigurationsRequestPayload, GetCompatibleAudioSourceConfigurationsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetCompatibleAudioSourceConfigurationsCommandInvoker"/> class.
            /// </summary>
            public GetCompatibleAudioSourceConfigurationsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetCompatibleAudioSourceConfigurations", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetCompatibleAudioSourceConfigurations";
            }
        }
    }
}
