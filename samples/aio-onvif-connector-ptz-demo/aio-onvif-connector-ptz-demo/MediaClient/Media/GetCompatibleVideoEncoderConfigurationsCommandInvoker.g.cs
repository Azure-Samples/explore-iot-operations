...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetCompatibleVideoEncoderConfigurations'.
        /// </summary>
        public class GetCompatibleVideoEncoderConfigurationsCommandInvoker : CommandInvoker<GetCompatibleVideoEncoderConfigurationsRequestPayload, GetCompatibleVideoEncoderConfigurationsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetCompatibleVideoEncoderConfigurationsCommandInvoker"/> class.
            /// </summary>
            public GetCompatibleVideoEncoderConfigurationsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetCompatibleVideoEncoderConfigurations", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetCompatibleVideoEncoderConfigurations";
            }
        }
    }
}
