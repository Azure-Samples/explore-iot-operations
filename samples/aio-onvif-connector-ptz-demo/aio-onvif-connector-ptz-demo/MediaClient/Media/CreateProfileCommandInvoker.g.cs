...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'CreateProfile'.
        /// </summary>
        public class CreateProfileCommandInvoker : CommandInvoker<CreateProfileRequestPayload, CreateProfileResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CreateProfileCommandInvoker"/> class.
            /// </summary>
            public CreateProfileCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "CreateProfile", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "CreateProfile";
            }
        }
    }
}
