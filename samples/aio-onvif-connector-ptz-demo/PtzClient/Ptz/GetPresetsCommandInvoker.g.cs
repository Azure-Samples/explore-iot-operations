...
namespace PtzClient.Ptz
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetPresets'.
        /// </summary>
        public class GetPresetsCommandInvoker : CommandInvoker<GetPresetsRequestPayload, GetPresetsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetPresetsCommandInvoker"/> class.
            /// </summary>
            public GetPresetsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetPresets", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetPresets";
            }
        }
    }
}
