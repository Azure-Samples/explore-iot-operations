...
namespace PtzClient.Ptz
{
    ...
    public static partial class Ptz
    {
        ...
        public class GetConfigurationOptionsCommandInvoker : CommandInvoker<GetConfigurationOptionsRequestPayload, GetConfigurationOptionsResponsePayload>
        {
            ...
            /// </summary>
            public GetConfigurationOptionsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetConfigurationOptions", new Utf8JsonSerializer())
            {
                this.ResponseTopicPrefix = "clients/{invokerClientId}"; // default value, can be overwritten by user code

                this.effectiveTopicTokenMap = new(string.Empty, (IReadOnlyDictionary<string, string>)base.TopicTokenMap, "ex:", this.CustomTopicTokenMap);

                base.TopicTokenMap["modelId"] = "dtmi:onvif:ptz;1";
                if (mqttClient.ClientId != null)
                {
                    base.TopicTokenMap["invokerClientId"] = mqttClient.ClientId;
                }
                base.TopicTokenMap["commandName"] = "GetConfigurationOptions";
            }
        }
    }
}
