...
namespace PtzClient.Ptz
{
    ...
    public static partial class Ptz
    {
        ...
        public class GetStatusCommandInvoker : CommandInvoker<GetStatusRequestPayload, GetStatusResponsePayload>
        {
            ...
            /// </summary>
            public GetStatusCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetStatus", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetStatus";
            }
        }
    }
}
