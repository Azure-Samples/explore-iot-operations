...
namespace PtzClient.Ptz
{
    ...
    public static partial class Ptz
    {
        ...
        public class SetPresetCommandInvoker : CommandInvoker<SetPresetRequestPayload, SetPresetResponsePayload>
        {
            ...
            /// </summary>
            public SetPresetCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "SetPreset", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "SetPreset";
            }
        }
    }
}
