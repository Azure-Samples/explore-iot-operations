...
namespace PtzClient.Ptz
{
    ...
    public static partial class Ptz
    {
        ...
        public class GetNodeCommandInvoker : CommandInvoker<GetNodeRequestPayload, GetNodeResponsePayload>
        {
            ...
            /// </summary>
            public GetNodeCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetNode", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetNode";
            }
        }
    }
}
