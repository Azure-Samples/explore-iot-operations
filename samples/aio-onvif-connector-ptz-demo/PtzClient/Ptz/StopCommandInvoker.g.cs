...
namespace PtzClient.Ptz
{
    ...
    public static partial class Ptz
    {
        ...
        public class StopCommandInvoker : CommandInvoker<StopRequestPayload, EmptyJson>
        {
            ...
            /// </summary>
            public StopCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "Stop", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "Stop";
            }
        }
    }
}
