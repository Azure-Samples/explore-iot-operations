...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetAudioSourceConfigurationOptions'.
        /// </summary>
        public class GetAudioSourceConfigurationOptionsCommandInvoker : CommandInvoker<GetAudioSourceConfigurationOptionsRequestPayload, GetAudioSourceConfigurationOptionsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetAudioSourceConfigurationOptionsCommandInvoker"/> class.
            /// </summary>
            public GetAudioSourceConfigurationOptionsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetAudioSourceConfigurationOptions", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetAudioSourceConfigurationOptions";
            }
        }
    }
}
