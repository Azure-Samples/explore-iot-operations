...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetAudioSourceConfiguration'.
        /// </summary>
        public class GetAudioSourceConfigurationCommandInvoker : CommandInvoker<GetAudioSourceConfigurationRequestPayload, GetAudioSourceConfigurationResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetAudioSourceConfigurationCommandInvoker"/> class.
            /// </summary>
            public GetAudioSourceConfigurationCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetAudioSourceConfiguration", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetAudioSourceConfiguration";
            }
        }
    }
}
