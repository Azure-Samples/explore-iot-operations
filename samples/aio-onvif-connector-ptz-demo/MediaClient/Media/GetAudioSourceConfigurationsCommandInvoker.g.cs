...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetAudioSourceConfigurations'.
        /// </summary>
        public class GetAudioSourceConfigurationsCommandInvoker : CommandInvoker<EmptyJson, GetAudioSourceConfigurationsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetAudioSourceConfigurationsCommandInvoker"/> class.
            /// </summary>
            public GetAudioSourceConfigurationsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetAudioSourceConfigurations", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetAudioSourceConfigurations";
            }
        }
    }
}
