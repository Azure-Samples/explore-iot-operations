...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetCompatibleVideoSourceConfigurations'.
        /// </summary>
        public class GetCompatibleVideoSourceConfigurationsCommandInvoker : CommandInvoker<GetCompatibleVideoSourceConfigurationsRequestPayload, GetCompatibleVideoSourceConfigurationsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetCompatibleVideoSourceConfigurationsCommandInvoker"/> class.
            /// </summary>
            public GetCompatibleVideoSourceConfigurationsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetCompatibleVideoSourceConfigurations", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetCompatibleVideoSourceConfigurations";
            }
        }
    }
}
