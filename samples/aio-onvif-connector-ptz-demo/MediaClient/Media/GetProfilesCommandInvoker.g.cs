...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetProfiles'.
        /// </summary>
        public class GetProfilesCommandInvoker : CommandInvoker<EmptyJson, GetProfilesResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetProfilesCommandInvoker"/> class.
            /// </summary>
            public GetProfilesCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetProfiles", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetProfiles";
            }
        }
    }
}
