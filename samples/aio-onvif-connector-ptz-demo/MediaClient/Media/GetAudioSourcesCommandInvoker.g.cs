...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetAudioSources'.
        /// </summary>
        public class GetAudioSourcesCommandInvoker : CommandInvoker<EmptyJson, GetAudioSourcesResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetAudioSourcesCommandInvoker"/> class.
            /// </summary>
            public GetAudioSourcesCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetAudioSources", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetAudioSources";
            }
        }
    }
}
