...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetVideoEncoderConfiguration'.
        /// </summary>
        public class GetVideoEncoderConfigurationCommandInvoker : CommandInvoker<GetVideoEncoderConfigurationRequestPayload, GetVideoEncoderConfigurationResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetVideoEncoderConfigurationCommandInvoker"/> class.
            /// </summary>
            public GetVideoEncoderConfigurationCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetVideoEncoderConfiguration", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetVideoEncoderConfiguration";
            }
        }
    }
}
