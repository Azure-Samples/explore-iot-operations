...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetMetadataConfigurations'.
        /// </summary>
        public class GetMetadataConfigurationsCommandInvoker : CommandInvoker<EmptyJson, GetMetadataConfigurationsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetMetadataConfigurationsCommandInvoker"/> class.
            /// </summary>
            public GetMetadataConfigurationsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetMetadataConfigurations", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetMetadataConfigurations";
            }
        }
    }
}
