...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetCompatibleMetadataConfigurations'.
        /// </summary>
        public class GetCompatibleMetadataConfigurationsCommandInvoker : CommandInvoker<GetCompatibleMetadataConfigurationsRequestPayload, GetCompatibleMetadataConfigurationsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetCompatibleMetadataConfigurationsCommandInvoker"/> class.
            /// </summary>
            public GetCompatibleMetadataConfigurationsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetCompatibleMetadataConfigurations", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetCompatibleMetadataConfigurations";
            }
        }
    }
}
