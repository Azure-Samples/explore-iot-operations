...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetVideoEncoderConfigurationOptions'.
        /// </summary>
        public class GetVideoEncoderConfigurationOptionsCommandInvoker : CommandInvoker<GetVideoEncoderConfigurationOptionsRequestPayload, GetVideoEncoderConfigurationOptionsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetVideoEncoderConfigurationOptionsCommandInvoker"/> class.
            /// </summary>
            public GetVideoEncoderConfigurationOptionsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetVideoEncoderConfigurationOptions", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetVideoEncoderConfigurationOptions";
            }
        }
    }
}
