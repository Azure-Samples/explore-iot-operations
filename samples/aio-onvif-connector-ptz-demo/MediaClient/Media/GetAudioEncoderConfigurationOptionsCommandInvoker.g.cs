...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetAudioEncoderConfigurationOptions'.
        /// </summary>
        public class GetAudioEncoderConfigurationOptionsCommandInvoker : CommandInvoker<GetAudioEncoderConfigurationOptionsRequestPayload, GetAudioEncoderConfigurationOptionsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetAudioEncoderConfigurationOptionsCommandInvoker"/> class.
            /// </summary>
            public GetAudioEncoderConfigurationOptionsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetAudioEncoderConfigurationOptions", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetAudioEncoderConfigurationOptions";
            }
        }
    }
}
