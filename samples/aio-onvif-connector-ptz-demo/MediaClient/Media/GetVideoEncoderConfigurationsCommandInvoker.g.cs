...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetVideoEncoderConfigurations'.
        /// </summary>
        public class GetVideoEncoderConfigurationsCommandInvoker : CommandInvoker<EmptyJson, GetVideoEncoderConfigurationsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetVideoEncoderConfigurationsCommandInvoker"/> class.
            /// </summary>
            public GetVideoEncoderConfigurationsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetVideoEncoderConfigurations", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetVideoEncoderConfigurations";
            }
        }
    }
}
