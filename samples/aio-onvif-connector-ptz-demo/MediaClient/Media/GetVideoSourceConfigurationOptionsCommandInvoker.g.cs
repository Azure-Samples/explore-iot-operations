...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetVideoSourceConfigurationOptions'.
        /// </summary>
        public class GetVideoSourceConfigurationOptionsCommandInvoker : CommandInvoker<GetVideoSourceConfigurationOptionsRequestPayload, GetVideoSourceConfigurationOptionsResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetVideoSourceConfigurationOptionsCommandInvoker"/> class.
            /// </summary>
            public GetVideoSourceConfigurationOptionsCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetVideoSourceConfigurationOptions", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetVideoSourceConfigurationOptions";
            }
        }
    }
}
