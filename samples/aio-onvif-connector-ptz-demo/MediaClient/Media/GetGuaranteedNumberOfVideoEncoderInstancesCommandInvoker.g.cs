...
namespace MediaClient.Media
{
    ...
    {
        /// <summary>
        /// Specializes the <c>CommandInvoker</c> class for Command 'GetGuaranteedNumberOfVideoEncoderInstances'.
        /// </summary>
        public class GetGuaranteedNumberOfVideoEncoderInstancesCommandInvoker : CommandInvoker<GetGuaranteedNumberOfVideoEncoderInstancesRequestPayload, GetGuaranteedNumberOfVideoEncoderInstancesResponsePayload>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GetGuaranteedNumberOfVideoEncoderInstancesCommandInvoker"/> class.
            /// </summary>
            public GetGuaranteedNumberOfVideoEncoderInstancesCommandInvoker(ApplicationContext applicationContext, IMqttPubSubClient mqttClient)
                : base(applicationContext, mqttClient, "GetGuaranteedNumberOfVideoEncoderInstances", new Utf8JsonSerializer())
            {
                ...
                base.TopicTokenMap["commandName"] = "GetGuaranteedNumberOfVideoEncoderInstances";
            }
        }
    }
}
