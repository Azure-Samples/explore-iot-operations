...
. (Join-Path -Path $PSScriptRoot -ChildPath "Update-MediaServerConfigFiles.ps1")
...
$mediaServer = (Get-Content -Path (Join-Path -Path $PSScriptRoot -ChildPath ".config_media_server_host") -Raw).Trim()
